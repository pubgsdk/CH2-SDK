...
#include "Ammo_FireHeavyCrossbowBolt_structs.hpp"
...
// BlueprintGeneratedClass Ammo_FireHeavyCrossbowBolt.Ammo_FireHeavyCrossbowBolt_C
// 0x002D (0x1251 - 0x1224)
class AAmmo_FireHeavyCrossbowBolt_C : public ABaseArrow_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Ammo_FireHeavyCrossbowBolt.Ammo_FireHeavyCrossbowBolt_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_Ammo_FireHeavyCrossbowBolt(int EntryPoint);
};
