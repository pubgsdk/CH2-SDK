...
#include "Ammo_StandardArrow_structs.hpp"
...
// BlueprintGeneratedClass Ammo_StandardArrow.Ammo_StandardArrow_C
// 0x001D (0x1241 - 0x1224)
class AAmmo_StandardArrow_C : public ABaseArrow_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Ammo_StandardArrow.Ammo_StandardArrow_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_Ammo_StandardArrow(int EntryPoint);
};
