...
struct FAnimationStateEntry
{
	...
	TArray<struct FAnimationSetup>                     AnimationSetups;                                          // 0x0008(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
struct FPerSkeletonAnimationSharingSetup
{
	...
	TArray<struct FAnimationStateEntry>                AnimationStates;                                          // 0x0028(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
};
