...
// BlueprintGeneratedClass Aura_Jab.Aura_Jab_C
// 0x0010 (0x0268 - 0x0258)
class AAura_Jab_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Aura_Jab.Aura_Jab_C"));
		return ptr;
	}
