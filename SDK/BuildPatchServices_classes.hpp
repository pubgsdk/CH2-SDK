...
public:
	...
	TSet<struct FString>                               PrereqIds;                                                // 0x0070(0x0050) (CPF_NativeAccessSpecifierPublic)
	...
	TArray<struct FFileManifestData>                   FileManifestList;                                         // 0x00F0(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	TArray<struct FChunkInfoData>                      ChunkList;                                                // 0x0100(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	TArray<struct FCustomFieldData>                    CustomFields;                                             // 0x0110(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
