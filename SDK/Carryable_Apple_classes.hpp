...
#include "Carryable_Apple_structs.hpp"
...
// BlueprintGeneratedClass Carryable_Apple.Carryable_Apple_C
// 0x000F (0x1270 - 0x1261)
class ACarryable_Apple_C : public ABaseCarryable_Offhand_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Carryable_Apple.Carryable_Apple_C"));
		return ptr;
	}
