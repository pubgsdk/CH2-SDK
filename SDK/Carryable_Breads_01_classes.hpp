...
#include "Carryable_Breads_01_structs.hpp"
...
public:
	...
	int                                                VisualIndex;                                              // 0x1278(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Carryable_Breads_01.Carryable_Breads_01_C"));
		return ptr;
	}
