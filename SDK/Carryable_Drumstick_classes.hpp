...
#include "Carryable_Drumstick_structs.hpp"
...
// BlueprintGeneratedClass Carryable_Drumstick.Carryable_Drumstick_C
// 0x0017 (0x1278 - 0x1261)
class ACarryable_Drumstick_C : public ABaseCarryable_Offhand_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Carryable_Drumstick.Carryable_Drumstick_C"));
		return ptr;
	}


	void OnInitialize();
	void ExecuteUbergraph_Carryable_Drumstick(int EntryPoint);
};
