...
#include "GrantVictoryToRed_classes.hpp"
...
TScriptInterface<class UStageInterface> UGrantVictoryToRed_C::CompleteStage()
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function GrantVictoryToRed.GrantVictoryToRed_C.CompleteStage"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function GrantVictoryToRed.GrantVictoryToRed_C.IsStageReadyToComplete"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function GrantVictoryToRed.GrantVictoryToRed_C.TimeoutStage"));
