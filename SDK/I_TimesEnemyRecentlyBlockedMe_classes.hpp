...
#include "I_TimesEnemyRecentlyBlockedMe_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass I_TimesEnemyRecentlyBlockedMe.I_TimesEnemyRecentlyBlockedMe_C"));
		return ptr;
	}
