...
struct FImageWriteOptions
{
	...
	struct FScriptDelegate                             OnComplete;                                               // 0x0004(0x0010) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
