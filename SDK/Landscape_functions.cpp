...
// Function Landscape.LandscapeProxy.GetLayerInfoObjectByName
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
// struct FName                   LayerName                      (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
// class ULandscapeLayerInfoObject* ReturnValue                    (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

class ULandscapeLayerInfoObject* ALandscapeProxy::GetLayerInfoObjectByName(const struct FName& LayerName)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Landscape.LandscapeProxy.GetLayerInfoObjectByName"));

	struct
	{
		struct FName                   LayerName;
		class ULandscapeLayerInfoObject* ReturnValue;
	} params = {};
...
// Function Landscape.LandscapeProxy.GetAllLayerNames
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_HasOutParms, FUNC_BlueprintCallable)
// Parameters:
// TArray<struct FName>           LayerNames                     (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void ALandscapeProxy::GetAllLayerNames(TArray<struct FName>* LayerNames)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Landscape.LandscapeProxy.GetAllLayerNames"));
...
// (FUNC_Event, FUNC_Public, FUNC_HasOutParms, FUNC_BlueprintEvent)
// Parameters:
// TArray<class UTexture2D*>      OutStreamableAssets            (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
void ALandscapeBlueprintBrushBase::GetBlueprintRenderDependencies(TArray<class UTexture2D*>* OutStreamableAssets)
{
	...
	struct
	{
		TArray<class UTexture2D*>      OutStreamableAssets;
	} params = {};
...
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
// TArray<class USplineMeshComponent*> ReturnValue                    (CPF_ExportObject, CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_ContainsInstancedReference, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
