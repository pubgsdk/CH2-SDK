...
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
// TArray<class AActor*>          AdditionalReceivers            (CPF_Parm, CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void ALevelSequenceActor::SetEventReceivers(TArray<class AActor*> AdditionalReceivers)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function LevelSequence.LevelSequenceActor.SetEventReceivers"));
...
// TArray<class AActor*>          Actors                         (CPF_ConstParm, CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReferenceParm, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
// Function LevelSequence.LevelSequenceActor.SequencePlaybackUpdated
// (FUNC_Final, FUNC_Native, FUNC_Protected)
// Parameters:
// class UMovieSceneSequencePlayer* Sequence                       (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
// TEnumAsByte<EMovieScenePlayerStatus> Status                         (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void ALevelSequenceActor::SequencePlaybackUpdated(class UMovieSceneSequencePlayer* Sequence, TEnumAsByte<EMovieScenePlayerStatus> Status)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function LevelSequence.LevelSequenceActor.SequencePlaybackUpdated"));

	struct
	{
		class UMovieSceneSequencePlayer* Sequence;
