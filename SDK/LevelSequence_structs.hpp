...
{
	TArray<struct FLevelSequenceBindingReference>      References;                                               // 0x0000(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
};
...
struct FLevelSequenceBindingReferences
{
	...
	TSet<struct FGuid>                                 AnimSequenceInstances;                                    // 0x0050(0x0050) (CPF_NativeAccessSpecifierPrivate)
};
