...
public:
	...
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0300(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_NoDestructor, CPF_NativeAccessSpecifierPrivate)
	struct FMulticastScriptDelegate                    OnAudioFinished;                                          // 0x0310(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_NativeAccessSpecifierPrivate)
	struct FMulticastScriptDelegate                    OnAudioPlaybackPercent;                                   // 0x0320(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_NativeAccessSpecifierPrivate)
...
public:
	...
	class UClass* /*UCameraShake*/                     ShakeClass;                                               // 0x0100(0x0008) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
{
public:
	class UClass* /*UObject*/                          PropertyClass;                                            // 0x0088(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
