...
// Enum MovieScene.EMovieScenePlayerStatusK2
enum class EMovieScenePlayerStatusK2 : uint8_t
{
	EMovieScenePlayerStatusK2__Stopped = 0,
	EMovieScenePlayerStatusK2__Playing = 1,
	EMovieScenePlayerStatusK2__Recording = 2,
	EMovieScenePlayerStatusK2__Scrubbing = 3,
	EMovieScenePlayerStatusK2__Jumping = 4,
	EMovieScenePlayerStatusK2__Stepping = 5,
	EMovieScenePlayerStatusK2__Paused = 6,
	EMovieScenePlayerStatusK2__MAX = 7
};
