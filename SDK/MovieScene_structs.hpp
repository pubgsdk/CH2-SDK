...
struct FMovieSceneSequencePlaybackSettings
{
	...
	unsigned char                                      bClientShouldSyncIfServerCompletedPlayback : 1;           // 0x0014(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      bShouldJumpInsteadOfPlayToEndOnSync : 1;                  // 0x0014(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
struct FMovieSceneRootEvaluationTemplateInstance
{
	...
	TMap<struct FMovieSceneSequenceID, class UObject*> DirectorInstances;                                        // 0x0020(0x0050) (CPF_NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData01[0x2B8];                                     // 0x0070(0x02B8) MISSED OFFSET
};
...
struct FMovieScenePossessable
{
	...
	class UClass* /*UObject*/                          PossessedObjectClass;                                     // 0x0030(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
...
struct FMovieSceneEditorData
{
	...
	TSet<struct FFrameNumber>                          MarkedFrames;                                             // 0x0080(0x0050) (CPF_Deprecated, CPF_NativeAccessSpecifierPublic)
...
{
	class UClass* /*UObject*/                          PropertyClass;                                            // 0x0008(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
	TArray<struct FFrameNumber>                        Times;                                                    // 0x0010(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
