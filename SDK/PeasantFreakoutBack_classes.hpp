...
#include "PeasantFreakoutBack_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass PeasantFreakoutBack.PeasantFreakoutBack_C"));
		return ptr;
	}
