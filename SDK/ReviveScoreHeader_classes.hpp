...
#include "ReviveScoreHeader_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass ReviveScoreHeader.ReviveScoreHeader_C"));
		return ptr;
	}
