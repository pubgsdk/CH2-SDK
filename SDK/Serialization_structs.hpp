...
{
	class UClass* /*UObject*/                          Class;                                                    // 0x0000(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	class UClass* /*UMetaData*/                        Subclass;                                                 // 0x0008(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                        SoftClass;                                                // 0x0010(0x0028) (CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
struct FStructSerializerBuiltinTestStruct
{
	...
	struct FColor                                      Color;                                                    // 0x0080(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
{
	TArray<int>                                        Int32Array;                                               // 0x0000(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	TArray<unsigned char>                              ByteArray;                                                // 0x0010(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	...
	TArray<struct FVector>                             VectorArray;                                              // 0x0040(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	TArray<struct FStructSerializerBuiltinTestStruct>  StructArray;                                              // 0x0050(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
};
...
{
	TSet<struct FString>                               StrSet;                                                   // 0x0000(0x0050) (CPF_NativeAccessSpecifierPublic)
	TSet<int>                                          IntSet;                                                   // 0x0050(0x0050) (CPF_NativeAccessSpecifierPublic)
	TSet<struct FName>                                 NameSet;                                                  // 0x00A0(0x0050) (CPF_NativeAccessSpecifierPublic)
	TSet<struct FStructSerializerBuiltinTestStruct>    StructSet;                                                // 0x00F0(0x0050) (CPF_NativeAccessSpecifierPublic)
};
...
struct FStructSerializerByteArray
{
	...
	TArray<unsigned char>                              ByteArray;                                                // 0x0008(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	...
	TArray<int8_t>                                     Int8Array;                                                // 0x0020(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
