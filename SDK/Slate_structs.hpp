...
{
	TArray<struct FName>                               Names;                                                    // 0x0000(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
};
...
struct FCustomizedToolMenu
{
	...
	TArray<struct FName>                               SectionOrder;                                             // 0x00F8(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
