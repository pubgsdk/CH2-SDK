...
#include "SpectatingState_structs.hpp"
...
// BlueprintGeneratedClass SpectatingState.SpectatingState_C
// 0x0017 (0x0048 - 0x0031)
class USpectatingState_C : public UBaseCinematicState_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass SpectatingState.SpectatingState_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_SpectatingState(int EntryPoint);
};
