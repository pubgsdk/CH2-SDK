...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StaticMeshDescription.StaticMeshDescription.SetVertexInstanceUV"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StaticMeshDescription.StaticMeshDescription.SetPolygonGroupMaterialSlotName"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StaticMeshDescription.StaticMeshDescription.GetVertexInstanceUV"));
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StaticMeshDescription.StaticMeshDescription.CreateCube"));
