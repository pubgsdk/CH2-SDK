...
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable, FUNC_BlueprintPure, FUNC_Const)
// Parameters:
// TArray<class UWidget*>         ReturnValue                    (CPF_ExportObject, CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_ContainsInstancedReference, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UMG.ScrollBox.GetScrollToEndOffset"));
...
// Function UMG.ScrollBox.GetScrolledPercent
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable, FUNC_BlueprintPure)
// Parameters:
// float                          ReturnValue                    (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

float UScrollBox::GetScrolledPercent()
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UMG.ScrollBox.GetScrolledPercent"));
...
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable, FUNC_BlueprintPure, FUNC_Const)
// Parameters:
// TArray<class UUserWidget*>     ReturnValue                    (CPF_ConstParm, CPF_ExportObject, CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_ReferenceParm, CPF_ContainsInstancedReference, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
// Function UMG.UserWidget.AddToClusterAsMutable
// (FUNC_Final, FUNC_BlueprintCosmetic, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
...
void UUserWidget::AddToClusterAsMutable(class UObject* Object)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UMG.UserWidget.AddToClusterAsMutable"));
...
// Function UMG.UserWidget.AddClassToClusterAsMutable
// (FUNC_Final, FUNC_BlueprintCosmetic, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
// class UClass* /*UObject*/      Klass                          (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void UUserWidget::AddClassToClusterAsMutable(class UClass* /*UObject*/ Klass)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UMG.UserWidget.AddClassToClusterAsMutable"));

	struct
	{
		class UClass* /*UObject*/      Klass;
	} params = {};
...
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable, FUNC_BlueprintPure, FUNC_Const)
// Parameters:
// TArray<class UObject*>         ReturnValue                    (CPF_ConstParm, CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_ReferenceParm, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
// Parameters:
// TArray<class UObject*>         InListItems                    (CPF_ConstParm, CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReferenceParm, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
// Parameters:
// TArray<class UObject*>         Items                          (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
// bool                           ReturnValue                    (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReturnParm, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_HasOutParms, FUNC_BlueprintCallable)
// Parameters:
// TArray<struct FKey>            InKeys                         (CPF_ConstParm, CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReferenceParm, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UMG.OverlaySlot.SetZOrder"));
...
// Function UMG.TextBlock.SetFontSize
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
...
void UTextBlock::SetFontSize(int Size)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UMG.TextBlock.SetFontSize"));
...
void UTextBlock::SetFontMaterial(class UMaterialInterface* Material)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UMG.TextBlock.SetFontMaterial"));
...
// Function UMG.VerticalBox.InsertChildIntoVerticalBox
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
// int                            Index                          (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
// class UWidget*                 Content                        (CPF_Parm, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
class UVerticalBoxSlot* UVerticalBox::InsertChildIntoVerticalBox(int Index, class UWidget* Content)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UMG.VerticalBox.InsertChildIntoVerticalBox"));
...
// class UObject*                 WorldContextObject             (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
// class APlayerController*       PlayerController               (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
// int                            InputIdNum                     (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
// int                            LastInputIDNum                 (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void UWidgetBlueprintLibrary::SetInputMode_UIOnlyEx(class UObject* WorldContextObject, class APlayerController* PlayerController, class UWidget* InWidgetToFocus, EMouseLockMode InMouseLockMode, int LastInputIDNum, int* InputIdNum)
{
	...
	params.LastInputIDNum = LastInputIDNum;
	...
	if (InputIdNum != nullptr)
		*InputIdNum = params.InputIdNum;
}
...
void UWidgetBlueprintLibrary::SetInputMode_GameOnly(class UObject* WorldContextObject, class APlayerController* PlayerController, int LastInputIDNum, int* InputIdNum)
{
...
void UWidgetBlueprintLibrary::SetInputMode_GameAndUIEx(class UObject* WorldContextObject, class APlayerController* PlayerController, class UWidget* InWidgetToFocus, EMouseLockMode InMouseLockMode, bool bHideCursorDuringCapture, int LastInputIDNum, int* InputIdNum)
{
...
// Parameters:
// class UObject*                 WorldContextObject             (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
// TArray<class UUserWidget*>     FoundWidgets                   (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ContainsInstancedReference, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
// Parameters:
// struct FPaintContext           Context                        (CPF_Parm, CPF_OutParm, CPF_ReferenceParm, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
// TArray<struct FVector2D>       Points                         (CPF_ConstParm, CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReferenceParm, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
// struct FLinearColor            Tint                           (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
// DelegateFunction UMG.WidgetSwitcher.OnActiveWidgetIndexChangedEvent__DelegateSignature
// (FUNC_MulticastDelegate, FUNC_Public, FUNC_Delegate)
// Parameters:
// int                            NewActiveWidgetIndex           (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void UWidgetSwitcher::OnActiveWidgetIndexChangedEvent__DelegateSignature(int NewActiveWidgetIndex)
{
	static UFunction* fn = UObject::FindObject<UFunction>(_xor_("DelegateFunction UMG.WidgetSwitcher.OnActiveWidgetIndexChangedEvent__DelegateSignature"));

	struct
	{
		int                            NewActiveWidgetIndex;
	} params = {};

	params.NewActiveWidgetIndex = NewActiveWidgetIndex;
