...
struct FAnimationEventBinding
{
	...
	struct FScriptDelegate                             Delegate;                                                 // 0x0008(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
...
struct FWidgetNavigationData
{
	...
	struct FScriptDelegate                             CustomDelegate;                                           // 0x0014(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
};
