...
#include "WeaponCrossbowProgression_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass WeaponCrossbowProgression.WeaponCrossbowProgression_C"));
		return ptr;
	}
