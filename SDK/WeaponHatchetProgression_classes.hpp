...
#include "WeaponHatchetProgression_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass WeaponHatchetProgression.WeaponHatchetProgression_C"));
		return ptr;
	}
