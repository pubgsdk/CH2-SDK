...
#include "WeaponMesserProgression_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass WeaponMesserProgression.WeaponMesserProgression_C"));
		return ptr;
	}
