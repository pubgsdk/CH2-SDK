...
#include "WeaponTwoHandedHammerProgression_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass WeaponTwoHandedHammerProgression.WeaponTwoHandedHammerProgression_C"));
		return ptr;
	}
