...
#include "Weapon_BaseOneHanded_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Weapon_BaseOneHanded.Weapon_BaseOneHanded_C"));
		return ptr;
	}
