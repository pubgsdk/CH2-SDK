...
#include "Weapon_BaseTwoHanded_structs.hpp"
...
// BlueprintGeneratedClass Weapon_BaseTwoHanded.Weapon_BaseTwoHanded_C
// 0x001C (0x12C0 - 0x12A4)
class AWeapon_BaseTwoHanded_C : public ABaseWeapon_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Weapon_BaseTwoHanded.Weapon_BaseTwoHanded_C"));
		return ptr;
	}


	void OnInitialize();
	void ExecuteUbergraph_Weapon_BaseTwoHanded(int EntryPoint);
};
