...
#include "Weapon_Catapult_structs.hpp"
...
// BlueprintGeneratedClass Weapon_Catapult.Weapon_Catapult_C
// 0x0009 (0x11F9 - 0x11F0)
class AWeapon_Catapult_C : public ABaseInventoryItem_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Weapon_Catapult.Weapon_Catapult_C"));
		return ptr;
	}
