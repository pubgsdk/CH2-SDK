...
#include "Weapon_Spear_structs.hpp"
...
class AWeapon_Spear_C : public AWeapon_BaseTwoHanded_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Weapon_Spear.Weapon_Spear_C"));
		return ptr;
	}
