...
#include "Weapon_WarBow_structs.hpp"
...
// BlueprintGeneratedClass Weapon_WarBow.Weapon_WarBow_C
// 0x001C (0x12C0 - 0x12A4)
class AWeapon_WarBow_C : public ABaseWeapon_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass Weapon_WarBow.Weapon_WarBow_C"));
		return ptr;
	}
