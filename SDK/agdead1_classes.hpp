...
// BlueprintGeneratedClass agdead1.agdead1_C
// 0x0030 (0x0288 - 0x0258)
class Aagdead1_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass agdead1.agdead1_C"));
		return ptr;
	}
