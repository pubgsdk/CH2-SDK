...
// BlueprintGeneratedClass dead_ag1.dead_ag1_C
// 0x0030 (0x0288 - 0x0258)
class Adead_ag1_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass dead_ag1.dead_ag1_C"));
		return ptr;
	}
