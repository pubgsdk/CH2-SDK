...
// BlueprintGeneratedClass dead_ag2.dead_ag2_C
// 0x0030 (0x0288 - 0x0258)
class Adead_ag2_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass dead_ag2.dead_ag2_C"));
		return ptr;
	}
