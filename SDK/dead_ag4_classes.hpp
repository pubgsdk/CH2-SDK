...
// BlueprintGeneratedClass dead_ag4.dead_ag4_C
// 0x0028 (0x0280 - 0x0258)
class Adead_ag4_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass dead_ag4.dead_ag4_C"));
		return ptr;
	}
