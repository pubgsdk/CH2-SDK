...
#include "dead_masonboi_structs.hpp"
...
// BlueprintGeneratedClass dead_masonboi.dead_masonboi_C
// 0x0038 (0x0290 - 0x0258)
class Adead_masonboi_C : public AActor
{
public:
	class USkeletalMeshComponent*                      Sword;                                                    // 0x0258(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass dead_masonboi.dead_masonboi_C"));
		return ptr;
	}
