...
#include "kneeling_victor_structs.hpp"
...
// BlueprintGeneratedClass kneeling_victor.kneeling_victor_C
// 0x0038 (0x0290 - 0x0258)
class Akneeling_victor_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass kneeling_victor.kneeling_victor_C"));
		return ptr;
	}
